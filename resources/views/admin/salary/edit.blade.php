                ...
                <div class="row">
                            ...
                            <select class="form-control" name="salary_category_id" id="salary_category_id">
                                ...
                                @foreach ($categories as $data)
                                    <option value="{{ $data->id }}" class="text-capitalize"
                                        {{ $salary->salary_category_id == $data->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="issue_date" class="form-control" id="issue_date"
                                placeholder="issue_date" value="{{ $salary->issue_date }}">
                            @error('issue_date')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="5">{{ $salary->description }}</textarea>
                            @error('description')
