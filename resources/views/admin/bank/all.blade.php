    ...
    <table id="back-account" class="table table-bordered table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center"><a  href="{{ route('admin.bank.edit', ['id'=> $bank->id])}}"><i class="fas fa-fw fa-edit"></i></a></td>
          <td class="text-center "><a onclick="confirm('Are your delete confirm?')" href="{{ route('admin.bank.delete', ['id'=> $bank->id])}}"><i class="fas fa-fw fa-trash text-danger"></i></a></td>
        </tr>
        @endforeach
      </tbody>
