...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{ route('admin.gngc.store') }}">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="amount" class="form-label">Amount <span class="text-danger">*</span></label>
                            <input type="number" name="amount" class="form-control" id="amount" placeholder="Amount" value="{{ old('amount') }}">
                            @error('amount')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            @error('description')
                                <div id="description" class="form-text text-danger">{{ old('description') }}</div>
                            @enderror
                        </div>
                    </div>
